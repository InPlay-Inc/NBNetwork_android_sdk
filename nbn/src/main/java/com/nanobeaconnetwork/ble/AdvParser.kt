...
internal object AdvParser {
     ...
     *
     * The library only extracts the EID (for dedup) and forwards the whole block base64-encoded;
    ...
    fun parse(serviceData: ByteArray): AdvData? {
        ...
        return AdvData(payload = Base64.getEncoder().encodeToString(serviceData), eid = eid)
    }
}
